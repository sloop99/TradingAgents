...
_METRICS: dict[str, tuple[tuple[str, str, str], ...]] = {
    ...
    # LongTermDebt has issuer-specific scope (and can be current, noncurrent,
    # or otherwise presented).  Preserve it as reported rather than asserting
    # that it is a total or adding it to any component.
    "short_term_borrowings": (("us-gaap", "ShortTermBorrowings", "Short-term borrowings"),),
    "commercial_paper": (("us-gaap", "CommercialPaper", "Commercial paper"),),
    "long_term_debt_reported": (("us-gaap", "LongTermDebt", "Long-term debt, as reported"),),
    ...
    "finance_lease_liability": (("us-gaap", "FinanceLeaseLiability", "Finance lease liability"),),
    "finance_lease_liability_current": (("us-gaap", "FinanceLeaseLiabilityCurrent", "Current finance lease liability"),),
    "finance_lease_liability_noncurrent": (("us-gaap", "FinanceLeaseLiabilityNoncurrent", "Noncurrent finance lease liability"),),
    ...
    "preferred_stock_value": (("us-gaap", "PreferredStockValue", "Preferred stock carrying value"),),
    "preferred_stock_liquidation_preference": (("us-gaap", "PreferredStockLiquidationPreferenceValue", "Preferred stock liquidation preference"),),
    "noncontrolling_interest_carrying": (("us-gaap", "MinorityInterest", "Noncontrolling interest carrying amount"),),
    "redeemable_nci_equity_carrying_amount": (("us-gaap", "RedeemableNoncontrollingInterestEquityCarryingAmount", "Redeemable noncontrolling interest equity carrying amount"),),
